...
export default function Profile() {
  ...
  const songTrack = [
    ...
    {index:1, isPlay:false, title:'Love Of A Lifetime',files:'/song/music.mp3'},
    {index:2, isPlay:false, title:'Lorem ipsum Lifetime',files:'https://vitejs.dev/vite.mp3'},
  ...
  return (
    <div className="wrapper bg-white">
      <div className="flex flex-col intro-music">
        <Header user={profile} intro={musicIntro} handleNext={handleNext} handlePrevious={handlePrevious} isPlay={play} setPlay={setPlay}/>
        
      </div>
      <div className={(action === 'edit' ? 'w-full md:w-10/12': 'w-full md:w-4/6 xl:w-8/12')+" px-8 md:px-0 flex flex-col md:flex-row body mx-auto py-16 space-x-0 space-y-16 md:space-y-0 md:space-x-8"}>
